...
public class HECExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<HECErrorResponse> handleException(ChannelNotFoundException exc) {
    ...
    @ExceptionHandler
    public ResponseEntity<HECErrorResponse> handleException(SessionNotFoundException exc) {
    ...
    @ExceptionHandler
    public ResponseEntity<HECErrorResponse> handleException(ChannelNotProvidedException exc) {
