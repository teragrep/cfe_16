...
class NumericalTimeTest {

    @Test
    @DisplayName("happy equals test")
    void happyEqualsTest() {
        final NumericalTime specifiedTime1 = new NumericalTime(
                new TimeObjectImpl(new ObjectMapper().createObjectNode().numberNode(12345))
        );
        final NumericalTime specifiedTime2 = new NumericalTime(
                new TimeObjectImpl(new ObjectMapper().createObjectNode().numberNode(12345))
        );
    ...
    void unhappyEqualsTest() {
        ...
        final NumericalTime specifiedTime2 = new NumericalTime(
                new TimeObjectImpl(new ObjectMapper().createObjectNode().numberNode(123456))
        );
