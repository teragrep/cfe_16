...
class AcknowledgedJsonResponseTest {

    @Test
    @DisplayName("equalsVerifier")
    void equalsVerifier() {
        EqualsVerifier.forClass(AcknowledgedJsonResponse.class).verify();
    }

    @Test
    @DisplayName("asJsonNodeResponseEntity() returns the correct message")
    void asJsonNodeResponseEntityReturnsTheCorrectMessage() {
        final Response response = new AcknowledgedJsonResponse("Body", 1);
