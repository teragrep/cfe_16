...
class XForwardedHostStubTest {

    @Test
    @DisplayName("equalsVerifier")
    void equalsVerifier() {
        EqualsVerifier.forClass(XForwardedHostStub.class).verify();
    }
    ...
    void valueThrowsUnsupportedOperationExceptionIfCalled() {
        ...
        final Exception exception = Assertions
                .assertThrowsExactly(UnsupportedOperationException.class, xForwardedHost::value);
