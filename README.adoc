...
The only supported protocol is RELP.
...
Test client is located in `src/test/java/com/teragrep/cfe_16/TestClient.java`
...
[source, shell script]
----
java -classpath target/test-classes com.teragrep.cfe_16.TestClient localhost 8080 1 4
----
